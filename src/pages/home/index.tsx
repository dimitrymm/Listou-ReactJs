...
export default function Home() {
  return (
    <div className="">
      <Header />
      <main className="flex  justify-center items-center md:flex-row flex-col">
            ...
            <CarouselContent>
              {!sliderData ? (
                <div role="status" className="text-center">
                  <svg
                    aria-hidden="true"
                    className="inline w-50 h-50 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                    viewBox="0 0 100 101"
                    fill="none"
